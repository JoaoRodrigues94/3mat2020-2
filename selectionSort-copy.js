/*
    ...
    2) A posição inicial do vetor a partir da qual sefeita a busca
    Retorno:
    -- A posição do menor valor encontrado
*/

/*
    fnComp recebe como parâmetro dois valores a serem comparados entre si.
    Retorna:
...
function selectionSort(vetor, fnComp){
    ...
    for(let i = 0; i < vetor.length - 1; i++){
        ...
        if(fnComp(vetor[i] > vetor[posMenor])){
            ...
            [vetor[i], vetor[posMenor]] = [vetor[posMenor], vetor[i]] // troca os valores
            totalTrocas++
        }
    }
