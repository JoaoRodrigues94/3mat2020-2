// Adaptar o algoritmo do Bubblo Sort para usar uma função de comparação
...
const candidatos = require('./dados/candidatos-2018')
console.time('Ordem NM_CANDIDATO')
bubbleSort(candidatos, (a,b) => a.NM_CANDIDATO.localeCompare(b.NM_CANDIDATO, 'pt-BR') > 0) // trata acentos.
console.timeEnd('Ordem NM_CANDIDATO')
console.log(candidatos)