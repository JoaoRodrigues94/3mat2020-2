...
module.exports = class BinarySeachTree {
    constructor(){
    ...
    insert(value){
        ...
        // Percorre a árvore para encontrar o local correto da inserção
    ...
    insertNode(node, root) {
        ...
        if(node.data < root.data) {
            ...
            // Possibilidade 2: o nodo á esquerda da raiz já está ocupado
